...
public class TemplateLab8Silver {
  ...
  public static void shuffle(ArrayList deck){
    for(int i=0; i < deck.size(); i++){
      ...
      if(i == 0 || i == 1)
        randomPosition = (int) (i + (Math.random() * deck.size()) );  // [0,deck.size()-1] = [0,19] = [0,20) = [0, deck.size() )
      // [0,deck.size()-1] = [0,19] = [0,20) = [0, deck.size() )
      // [1,deck.size()-1] = [1,19] = [1,20) = [1, deck.size() )

      if(i>1)
        randomPosition = (int) (i + (Math.random() * ((deck.size() - 1)-i) ) );   // min + (Math.random()*((max-min)))
      // [2,deck.size()-2] = [2,18] = [2,19) = [2, deck.size()-1 )
      // [3,deck.size()-2] = [3,18] = [3,19) = [3, deck.size()-1 )
      // [4,deck.size()-2] = [4,18] = [4,19) = [4, deck.size()-1 )
      //...
